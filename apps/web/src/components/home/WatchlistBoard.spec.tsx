...
vi.mock("@/lib/nbaApi", () => ({ fetchWatchlist: vi.fn() }));

// Following and unfollowing live on /v1/me, shared with the player pages —
// this board writes through the same client the rest of the app does.
vi.mock("@/lib/meApi", () => ({ unfollowPlayer: vi.fn() }));
